"""
DCNv2 Tutorial: AutoGluon 커스텀 모델 사용 예제

이 튜토리얼은 DCNv2 모델을 AutoGluon에 통합하고 사용하는 방법을 보여줍니다.
"""
...
print("=== DCNv2 Tutorial ===")
print("DCNv2 모델을 AutoGluon에 통합하고 학습하는 예제입니다.")
...
# DCNv2 모델 학습 (Cosine Annealing 스케줄러 포함)
print("\n2. DCNv2 모델 학습 중...")
predictor = TabularPredictor(label="Class", problem_type="binary", eval_metric="f1", path="models/dcnv2_tutorial").fit(
    train_data,
    hyperparameters={
        "DCNV2": {
            "num_cross_layers": 2,
